...
public class WrongOCP2 {
    ...
    В случае, если у нас топливо - электроэнергия, то это другие единицы измерения и другое название.
    В дочернем классе ECar создается другой метод,  а это модификация.
     */
